...
puts "Creating Users"
user_1 = User.create!(first_name: "Gabriel", last_name: "Campista", email: "gcamps@example.com", password: "123456", nickname: "Herrera", bio: "I'm awesome! Love beer, Flamengo supporter, average photographer, wanna be developer. Here my random (not funny) observations. CEO Twitter-clone")
...
user_17 = User.create!(first_name: "Andre", last_name: "Malta", email: "deco@example.com", password: "123456", nickname: "Russo", bio: "A expressão Lorem ipsum em design gráfico e editoração é um texto padrão em latim utilizado na produção gráfica para preencher os espaços de texto em publicações para testar e ajustar aspectos visuais antes de utilizar conteúdo real.")
